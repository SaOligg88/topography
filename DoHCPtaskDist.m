...
[clusL7] = DoPathsHCP(rsn7(1:32492),3,'L');
[clusR7] = DoPathsHCP(rsn7(32493:32492*2),3,'R');
...
[clusL17] = DoPathsHCP(rsn17(1:32492),3,'L');
[clusR17] = DoPathsHCP(rsn17(32493:32492*2),3,'R');
...
[distDMNL, zonesDMNL] = DoExactGeodesic(DMNpeaksL, 'L');
[distDMNR, zonesDMNR] = DoExactGeodesic(DMNpeaksR, 'R');
...
distDMN = [distDMNL; distDMNR];
zonesDMN = [zonesDMNL; zonesDMNR];
[surf] = GetHCPSurfs();
% make maps
