function[dist2mask] = DoFindPaths_LSD(subject)
% subID = subjectID in quotes

% set variables:
addpath(genpath('../../utils'));
thresh = 2;		
hemispheres   = 'lh'; 	% 'lh' or 'rh'
dir1   = '/scr/ilz2/LEMON_LSD/freesurfer/'; 	% locations of freesurfer directory containing subID
...
for h = 1:length(hemi)
    ...
    for i = 1:length(mask)
        ...
        dist2mask(i) = min(distanceMap(ismember(labelannot, colortable.table(mask(i),end))));
    end
end
